function estPalindrome(){                                                   // ici pas besoin de renseigner de paramètres donc je peux laisser les () vides ! car ma valeur qui serait mot est à déterminer par le prompt
    let mot = String(prompt("S'agit-il d'un palindrome ?"))                 // Quand ta fonction n’a pas besoin d’infos externes, tu ne mets rien dans les parenthèses. C’est un peu comme dire :
